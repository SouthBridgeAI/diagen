---
layout: post
title: "Building a Rakis"
date: 2024-06-18 00:00:00
image: "/images/posts/rakis-st1/cover.png"
description: "Repeatable inference network with only browsers for nodes"
tags:
  - Crypto
  - AI
  - Rakis
  - Trustless Inferences
  - LLMs
...
categories:
  - Large Language Models
  - Cryptocurrencies
twitter_text: "Running verifiable inference with only browsers for nodes"
---
...
The concept for Rakis came out of conversations between me and [DgtJulian](https://x.com/dgt_julian). If you can add a `callLLM()` instruction to the modern smart contract instruction set, you make two things happen simultaneously:
